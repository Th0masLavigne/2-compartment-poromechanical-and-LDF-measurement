...
# 
F = variational_forms.variational_form_2_mono_updated_isotropic_k_b(previous_solution, solution, ql, qb, w, E, nu, k_l, mu_l, k_b, mu_b, varepsilonb, K, alpha, dx, ds, dt, constitutive_laws.Elastic_constitutive_law, evolution_rule)
#
