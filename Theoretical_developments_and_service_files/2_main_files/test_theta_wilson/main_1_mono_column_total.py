...
# 
F = variational_forms_TW.variational_form_1_mono_total(previous_solution, solution, ql, w, E, nu, k_l, mu_l, dx, ds, dt, constitutive_laws.Elastic_constitutive_law)
# Add Neuman BCs
