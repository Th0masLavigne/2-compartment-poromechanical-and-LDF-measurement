...
dt             = dolfinx.default_scalar_type(0.5)
t              = t_init
...
k_b_current          = constitutive_laws.vascular_permeability_scalar_mono(k_b,alpha,varepsilonb,previous_solution.sub(0)+solution.sub(0),previous_solution.sub(1)+solution.sub(1),K,evolution_rule)
# 
...
xdmf = dolfinx.io.XDMFFile(mesh.comm, "_Indentation_Result_2_comp.xdmf", "w")
...
# 
F = variational_forms_TW.variational_form_2_mono_updated_isotropic_k_b(previous_solution, solution, ql, qb, w, E, nu, k_l, mu_l, k_b, mu_b, varepsilonb, K, alpha, dx, ds, dt, constitutive_laws.Elastic_constitutive_law, evolution_rule)
#
