...
# 
# F = variational_forms_TW.variational_form_2_mono_updated_anisotropic_k_b_constant(previous_solution, solution, ql, qb, w, E, nu, k_l, mu_l, k_b, ratio, mu_b, varepsilonb, K, alpha, dx, ds, dt, constitutive_laws.Elastic_constitutive_law, evolution_rule)
# F = variational_forms_TW.variational_form_2_mono_updated_anisotropic_k_b_product_outside_dot(previous_solution, solution, ql, qb, w, E, nu, k_l, mu_l, k_b, ratio, mu_b, varepsilonb, K, alpha, dx, ds, dt, constitutive_laws.Elastic_constitutive_law, evolution_rule)
F = variational_forms_TW.variational_form_2_mono_updated_anisotropic_k_b(previous_solution, solution, ql, qb, w, E, nu, k_l, mu_l, k_b, ratio, mu_b, varepsilonb, K, alpha, dx, ds, dt, constitutive_laws.Elastic_constitutive_law, evolution_rule)
# 
#
