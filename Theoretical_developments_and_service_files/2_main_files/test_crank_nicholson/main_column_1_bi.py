...
#
# 
F = variational_forms_TW.variational_form_1_comp_bi(previous_solution, solution, qc, ql, w, porosity_n, varepsilon_min, varepsilon_max, dt, E, nu, k_l, mu_l, k_c, mu_c, a, dx, ds)
# 
# Add Neuman BCs
