...
ax1.plot(time,pressure_solid_20,linestyle=':',linewidth=3,color='salmon', label='S, $\\mu^c=20$Pa.s')
ax1.plot(time,pressure_blood_1,linestyle='-',linewidth=3,color='thistle', label='B, $\\mu^c=1$Pa.s')
ax1.plot(time,pressure_blood_5,linestyle='-.',linewidth=3,color='thistle', label='B, $\\mu^c=5$Pa.s')
ax1.plot(time,pressure_blood_20,linestyle=':',linewidth=3,color='thistle', label='B, $\\mu^c=20$Pa.s')
ax1.plot(time,pressure_solid_1,linestyle='-',linewidth=3,color='cornflowerblue', label='S, $\\mu^c=1$Pa.s')
ax1.plot(time,pressure_solid_5,linestyle='-.',linewidth=3,color='tan', label='S, $\\mu^c=5$Pa.s')
...
plt.text(7, 105, r'$p^s~at~the~bottom~points$', fontsize = 12, color = 'gray')
plt.text(7, 30, r'$p^b~at~the~bottom~points$', fontsize = 12, color = 'gray')
...
fig1, ax1 = plt.subplots()
ax1.plot(time,pressure_IF_1,linestyle='-',linewidth=3,color='cornflowerblue', label='IF, $\\mu^c=1$Pa.s')
ax1.plot(time,pressure_IF_5,linestyle='-.',linewidth=3,color='tan', label='IF, $\\mu^c=5$Pa.s')
ax1.plot(time,pressure_IF_20,linestyle=':',linewidth=3,color='salmon', label='IF, $\\mu^c=20$Pa.s')
ax1.set_xlabel('time (s)')
...
fig1, ax1 = plt.subplots()
ax1.plot(time,pressure_cell_1,linestyle='-',linewidth=3,color='cornflowerblue', label='C, $\\mu^c=1$Pa.s')
ax1.plot(time,pressure_cell_5,linestyle='-.',linewidth=3,color='tan', label='C, $\\mu^c=5$Pa.s')
ax1.plot(time,pressure_cell_20,linestyle=':',linewidth=3,color='salmon', label='C, $\\mu^c=20$Pa.s')
ax1.set_xlabel('time (s)')
...
ax1.plot(time2,pressure_solid_20_,linestyle=':',linewidth=3,color='salmon', label='S, $\\mu^c=20$Pa.s')
ax1.plot(time2,pressure_blood_1_,linestyle='-',linewidth=3,color='thistle', label='B, $\\mu^c=1$Pa.s')
ax1.plot(time2,pressure_blood_5_,linestyle='-.',linewidth=3,color='thistle', label='B, $\\mu^c=5$Pa.s')
ax1.plot(time2,pressure_blood_20_,linestyle=':',linewidth=3,color='thistle', label='B, $\\mu^c=20$Pa.s')
ax1.plot(time2,pressure_solid_1_,linestyle='-',linewidth=3,color='cornflowerblue', label='S, $\\mu^c=1$Pa.s')
ax1.plot(time2,pressure_solid_5_,linestyle='-.',linewidth=3,color='tan', label='S, $\\mu^c=5$Pa.s')
# ax1.plot(ti2e_all,pressure_cell_all,linestyle='-.',linewidth=3,color='gray', label='C')
...
t.set_bbox(dict(facecolor='white', alpha=0.7, linewidth=0))
ax1.grid(color='lightgray', linestyle=':', linewidth=0.8,alpha=0.5)
plt.text(60, 105, r'$p^s~at~the~bottom~points$', fontsize = 12, color = 'gray')
plt.text(7, 30, r'$p^b~at~the~bottom~points$', fontsize = 12, color = 'gray')
# t=plt.text(5, 157, r'$4\%$', fontsize = 12, color = 'cornflowerblue')
# t.set_bbox(dict(facecolor='white', alpha=0.7, linewidth=0))
ax1.set_xlim([-10,120])
...
fig1, ax1 = plt.subplots()
ax1.plot(time2,pressure_IF_1_,linestyle='-',linewidth=3,color='cornflowerblue', label='IF, $\\mu^c=1$Pa.s')
ax1.plot(time2,pressure_IF_5_,linestyle='-.',linewidth=3,color='tan', label='IF, $\\mu^c=5$Pa.s')
ax1.plot(time2,pressure_IF_20_,linestyle=':',linewidth=3,color='salmon', label='IF, $\\mu^c=20$Pa.s')
ax1.set_xlabel('time (s)')
...
fig1, ax1 = plt.subplots()
ax1.plot(time2,pressure_cell_1_,linestyle='-',linewidth=3,color='cornflowerblue', label='C, $\\mu^c=1$Pa.s')
ax1.plot(time2,pressure_cell_5_,linestyle='-.',linewidth=3,color='tan', label='C, $\\mu^c=5$Pa.s')
ax1.plot(time2,pressure_cell_20_,linestyle=':',linewidth=3,color='salmon', label='C, $\\mu^c=20$Pa.s')
ax1.set_xlabel('time (s)')
ax1.set_ylabel('Cell Pressure (Pa)')
# ax1.ticklabel_format(axis="y", style="sci", scilimits=(0,0))
ax1.grid(color='lightgray', linestyle=':', linewidth=0.8)
...
ax1.plot(time2,varepsilon_1,linestyle='-',linewidth=3,color='cornflowerblue', label='IF, $\\mu^c=1$Pa.s')
ax1.plot(time2,varepsilon_5,linestyle='-.',linewidth=3,color='tan', label='IF, $\\mu^c=5$Pa.s')
ax1.plot(time2,varepsilon_20,linestyle=':',linewidth=3,color='salmon', label='IF, $\\mu^c=20$Pa.s')
ax1.set_xlabel('time (s)')
...
ax1.plot(time2,varepsilonb_1,linestyle='-',linewidth=3,color='cornflowerblue', label='B, $\\mu^c=1$Pa.s')
ax1.plot(time2,varepsilonb_5,linestyle='-.',linewidth=3,color='tan', label='B, $\\mu^c=5$Pa.s')
...
ax1d.plot(x,y,linestyle='--',linewidth=1.5,label='Lavigne al. (2023)',color='forestgreen')
ax1d.plot(x,y,linestyle='-',linewidth=1.5,label='$\\mu^c=1$Pa.s',color='cornflowerblue')
ax1d.plot(x,y,linestyle='-.',linewidth=1.5,label='$\\mu^c=5$Pa.s',color='tan')
ax1d.plot(x,y,linestyle=':',linewidth=1.5,label='$\\mu^c=20$Pa.s',color='salmon')
ax1d.axis('off')
