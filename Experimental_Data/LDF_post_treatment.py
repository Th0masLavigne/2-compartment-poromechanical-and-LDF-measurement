...
# 
# plt.plot(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE-110:index_22_ASE+length_list_ASE], ASE_mean_signal_raw, color='r', label="P$_2$", alpha=0.5)
# plt.fill_between(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE-110:index_22_ASE+length_list_ASE], ASE_mms_raw, ASE_mps_raw, color='r', alpha=0.2)
# # 
# plt.plot(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI-110:index_12_MDI+length_list_MDI], MDI_mean_signal_raw, color='g', label="P$_3$", alpha=0.5)
# plt.fill_between(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI-110:index_12_MDI+length_list_MDI], MDI_mms_raw, MDI_mps_raw, color='g', alpha=0.2)
plt.legend()
plt.xlim([-60, 780])
plt.ylim([0, 250])
plt.xlabel("Time [s]")
...
# plt.plot(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE-110:index_22_ASE+length_list_ASE], ASE_Temperaturemean_signal_raw, color='r', label="P$_2$", alpha=0.5)
# plt.fill_between(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE-110:index_22_ASE+length_list_ASE], ASE_Temperaturemms_raw, ASE_Temperaturemps_raw, color='r', alpha=0.2)
# # 
# plt.plot(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI-110:index_12_MDI+length_list_MDI], MDI_Temperaturemean_signal_raw, color='g', label="P$_3$", alpha=0.5)
# plt.fill_between(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI-110:index_12_MDI+length_list_MDI], MDI_Temperaturemms_raw, MDI_Temperaturemps_raw, color='g', alpha=0.2)
plt.legend()
plt.xlim([-60, 780])
# plt.ylim([27, 33])
plt.xlabel("Time [s]")
...
plt.rcParams.update({'font.size': 25})
plt.figure(figsize=(20, 12))
# plt.plot(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22-110:index_22+length_list], JOL_mean_signal_raw, color='b', label="P$_1$", alpha=0.5)
# plt.fill_between(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22-110:index_22+length_list], JOL_mms_raw, JOL_mps_raw, color='b', alpha=0.2)
# 
...
plt.rcParams.update({'font.size': 25})
plt.figure(figsize=(20, 12))
# plt.plot(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22-110:index_22+length_list], JOL_Temperaturemean_signal_raw, color='b', label="P$_1$", alpha=0.5)
# plt.fill_between(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22-110:index_22+length_list], JOL_Temperaturemms_raw, JOL_Temperaturemps_raw, color='b', alpha=0.2)
...
# # Load the Excel file
# file_path = "CXX_PREVAIL_LBM_035.xlsx"  # Change this to the path of your Excel file
...
# CXX_PREVAIL_LBM_035 = {}
# for sheet_name, data in all_sheets.items():
#     CXX_PREVAIL_LBM_035[sheet_name] = {col: data[col] for col in column_names if col in data.columns}

# index_11_CXX = 0
# for ii in range(len(CXX_PREVAIL_LBM_035["j1_1"]["temps (s)"] ) ):
# 	if CXX_PREVAIL_LBM_035["j1_1"]["temps (s)"][ii] == 0:
# 		index_11_CXX = ii 
# 		break
# index_12_CXX = 0
# for ii in range(len(CXX_PREVAIL_LBM_035["j1_2"]["temps (s)"] ) ):
# 	if CXX_PREVAIL_LBM_035["j1_2"]["temps (s)"][ii] == 0:
# 		index_12_CXX = ii 
# 		break
# # index_21_CXX = 0
# # for ii in range(len(CXX_PREVAIL_LBM_035["j2_1"]["temps (s)"] ) ):
# # 	if CXX_PREVAIL_LBM_035["j2_1"]["temps (s)"][ii] == 0:
# # 		index_21_CXX = ii 
# # 		break
# # index_22_CXX = 0
# # for ii in range(len(CXX_PREVAIL_LBM_035["j2_2"]["temps (s)"] ) ):
# # 	if CXX_PREVAIL_LBM_035["j2_2"]["temps (s)"][ii] == 0:
# # 		index_22_CXX = ii 
# # 		break		

# length_list_CXX = min(len(CXX_PREVAIL_LBM_035["j1_1"]["temps (s)"][index_11_CXX:]) , len(CXX_PREVAIL_LBM_035["j1_2"]["temps (s)"][index_12_CXX:]) )# , len(CXX_PREVAIL_LBM_035["j2_1"]["temps (s)"][index_21_CXX:]) , len(CXX_PREVAIL_LBM_035["j2_2"]["temps (s)"][index_22_CXX:] ) )

# CXX_Temperaturemean_signal=[]
# CXX_Temperaturemps = []
# CXX_Temperaturemms = []
# CXX_Temperaturestd_signal = []
# CXX_mean_signal=[]
# CXX_mps = []
# CXX_mms = []
# CXX_std_signal = []

# for i in range(length_list_CXX):
# 	CXX_mean_signal.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["PU_pc"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU_pc"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU_pc"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU_pc"][index_22_CXX+i] 
# 		] ) )
# 	# 
# 	CXX_std_signal.append( np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["PU_pc"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU_pc"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU_pc"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU_pc"][index_22_CXX+i] 
# 		] ) )
# 	# 
# 	CXX_mms.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["PU_pc"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU_pc"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU_pc"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU_pc"][index_22_CXX+i] 
# 		] )
# 	- 1.96* np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["PU_pc"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU_pc"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU_pc"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU_pc"][index_22_CXX+i] 
# 		] ) )
# 	# 
# 	CXX_mps.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["PU_pc"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU_pc"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU_pc"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU_pc"][index_22_CXX+i] 
# 		] )
...
# 		] ) )
# 	# 
# 	CXX_Temperaturemean_signal.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i] 
# 		] ) )
# 	# 
# 	CXX_Temperaturestd_signal.append( np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i] 
# 		] ) )
# 	# 
# 	CXX_Temperaturemms.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i] 
# 		] )
# 	-1.96*np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i] 
# 		] ) )
# 	# 
# 	CXX_Temperaturemps.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i] 
# 		] )
...
# CXX_Temperaturemean_signal_raw=[]
# CXX_Temperaturemps_raw = []
# CXX_Temperaturemms_raw = []
# CXX_Temperaturestd_signal_raw = []
# CXX_mean_signal_raw=[]
# CXX_mps_raw = []
# CXX_mms_raw = []
# CXX_std_signal_raw = []

# for i in range(length_list_CXX+110):
# 	CXX_mean_signal_raw.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["PU"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU"][index_22_CXX+i-110] 
# 		] ) )
# 	# 
# 	CXX_std_signal_raw.append( np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["PU"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU"][index_22_CXX+i-110] 
# 		] ) )
# 	# 
# 	CXX_mms_raw.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["PU"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU"][index_22_CXX+i-110] 
# 		] )
# 	-np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["PU"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU"][index_22_CXX+i-110] 
# 		] ) )
# 	# 
# 	CXX_mps_raw.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["PU"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["PU"][index_12_CXX+i-110] #,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["PU"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["PU"][index_22_CXX+i-110] 
# 		] )
...
# 		] ) )
# 	# 
# 	CXX_Temperaturemean_signal_raw.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i-110] 
# 		] ) )
# 	# 
# 	CXX_Temperaturestd_signal_raw.append( np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i-110] 
# 		] ) )
# 	# 
# 	CXX_Temperaturemms_raw.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i-110] 
# 		] )
# 	-np.std( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i-110] 
# 		] ) )
# 	# 
# 	CXX_Temperaturemps_raw.append( np.mean( [ CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i-110],
# 		CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i-110]#,
# 		# CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i-110] 
# 		] )
...
# plt.figure(figsize=(20, 12))
# # # 
# plt.plot(CXX_PREVAIL_LBM_035["j1_2"]["temps (s)"][index_12_CXX-110:index_12_CXX+length_list_CXX], CXX_mean_signal_raw, linestyle='-', color='gold', label="P$_11$", alpha=0.5)
# plt.fill_between(CXX_PREVAIL_LBM_035["j1_2"]["temps (s)"][index_12_CXX-110:index_12_CXX+length_list_CXX], CXX_mms_raw, CXX_mps_raw, color='gold', alpha=0.2)
# plt.legend()
# plt.xlim([-60, 780])
# plt.ylim([0, 250])
# plt.xlabel("Time [s]")
...
# plt.figure(figsize=(20, 12))
# # # 
# plt.plot(CXX_PREVAIL_LBM_035["j1_2"]["temps (s)"][index_12_CXX-110:index_12_CXX+length_list_CXX], CXX_Temperaturemean_signal_raw, linestyle='-', color='gold', label="P$_11$", alpha=0.5)
# plt.fill_between(CXX_PREVAIL_LBM_035["j1_2"]["temps (s)"][index_12_CXX-110:index_12_CXX+length_list_CXX], CXX_Temperaturemms_raw, CXX_Temperaturemps_raw, color='gold', alpha=0.2)
# plt.legend()
# plt.xlim([-60, 780])
# # plt.ylim([27, 33])
# plt.xlabel("Time [s]")
...
all_std=[]
all_std_temp =[]
# for i in range(min(length_list_ASE+110,length_list+110,length_list_MDI+110,length_list_MMA+110,length_list_CBO+110,length_list_PLA+110,length_list_JPE+110,length_list_MLM+110,length_list_ALA+110,length_list_AES+110,length_list_CXX+110)):
for i in range(min(length_list_ASE+110,length_list+110,length_list_MDI+110,length_list_MMA+110,length_list_CBO+110,length_list_PLA+110,length_list_JPE+110)):
	all_means.append( np.mean( [ ASE_PREVAIL_LBM_009["j1_1"]["PU"][index_11_ASE+i-110],
		...
		# # AES_PREVAIL_LBM_034["j2_2"]["PU"][index_22_AES+i-110] ,
		# # 
		# CXX_PREVAIL_LBM_035["j1_1"]["PU"][index_11_CXX+i-110],
		# CXX_PREVAIL_LBM_035["j1_2"]["PU"][index_12_CXX+i-110],
		# # CXX_PREVAIL_LBM_035["j2_1"]["PU"][index_21_CXX+i-110],
		# # CXX_PREVAIL_LBM_035["j2_2"]["PU"][index_22_CXX+i-110] 
		# 
	...
	all_means_temp.append( np.mean( [ ASE_PREVAIL_LBM_009["j1_1"]["Temperature"][index_11_ASE+i-110],
		...
		# # AES_PREVAIL_LBM_034["j2_2"]["Temperature"][index_22_AES+i-110] ,
		# # 
		# CXX_PREVAIL_LBM_035["j1_1"]["Temperature"][index_11_CXX+i-110],
		# CXX_PREVAIL_LBM_035["j1_2"]["Temperature"][index_12_CXX+i-110],
		# # CXX_PREVAIL_LBM_035["j2_1"]["Temperature"][index_21_CXX+i-110],
		# # CXX_PREVAIL_LBM_035["j2_2"]["Temperature"][index_22_CXX+i-110] 
		] ) )
...
all_std_pc=[]
# Percentage
# for i in range(min(length_list_ASE,length_list,length_list_MDI,length_list_MMA,length_list_CBO,length_list_PLA,length_list_JPE,length_list_MLM,length_list_ALA,length_list_AES,length_list_CXX)):
for i in range(min(length_list_ASE,length_list,length_list_MDI,length_list_MMA,length_list_CBO,length_list_PLA,length_list_JPE)):
	all_means_pc.append( np.mean( [ ASE_PREVAIL_LBM_009["j1_1"]["PU_pc"][index_11_ASE+i],
		...
		# # AES_PREVAIL_LBM_034["j2_2"]["PU_pc"][index_22_AES+i] ,
		# # 
		# CXX_PREVAIL_LBM_035["j1_1"]["PU_pc"][index_11_CXX+i],
		# CXX_PREVAIL_LBM_035["j1_2"]["PU_pc"][index_12_CXX+i],
		# # CXX_PREVAIL_LBM_035["j2_1"]["PU_pc"][index_21_CXX+i],
		# # CXX_PREVAIL_LBM_035["j2_2"]["PU_pc"][index_22_CXX+i] 
		#                               
...
# plt.plot(PLA_PREVAIL_LBM_030["j1_2"]["temps (s)"][index_12_PLA-110:index_12_PLA+length_list_PLA], PLA_mean_signal_raw, color='fuchsia', label="P$_9$", alpha=1, linewidth=3)
plt.legend()
plt.xlim([-60, 780])
plt.ylim([0, 250])
plt.xlabel("Time [s]")
...
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE-110:index_12_JPE+length_list_JPE], JPE_mean_signal_raw, linestyle='-', color='red', label="P$_8$", alpha=1, linewidth=3)
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE-110:index_12_JPE+length_list_JPE], JPE_mean_signal_raw, linestyle='-', color='darkgreen', label="P$_10$", alpha=1, linewidth=3)
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE-110:index_12_JPE+length_list_JPE], JPE_mean_signal_raw, linestyle='-', color='gold', label="P$_11$", alpha=1, linewidth=3)
plt.legend()
plt.xlim([-60, 780])
plt.ylim([0, 250])
plt.xlabel("Time [s]")
...
# plt.plot(PLA_PREVAIL_LBM_030["j1_2"]["temps (s)"][index_12_PLA:index_12_PLA+length_list_PLA], PLA_mean_signal, color='fuchsia', label="P$_9$", alpha=1, linewidth=3)
plt.legend()
plt.xlim([0, 780])
plt.ylim([0, 650])
plt.xlabel("Time [s]")
...
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE:index_12_JPE+length_list_JPE], JPE_mean_signal, linestyle='-', color='red', label="P$_8$", alpha=1, linewidth=3)
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE:index_12_JPE+length_list_JPE], JPE_mean_signal, linestyle='-', color='darkgreen', label="P$_10$", alpha=1, linewidth=3)
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE:index_12_JPE+length_list_JPE], JPE_mean_signal, linestyle='-', color='gold', label="P$_11$", alpha=1, linewidth=3)
plt.legend()
plt.xlim([0, 780])
plt.ylim([0, 650])
plt.xlabel("Time [s]")
...
plt.rcParams.update({'font.size': 25})
plt.figure(figsize=(20, 12))
plt.plot(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22:index_22+length_list], JOL_mean_signal, color='b', label="P$_1$", alpha=1, linewidth=3)
# plt.fill_between(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22-110:index_22+length_list], JOL_mms_raw, JOL_mps_raw, color='b', alpha=0.2)
# 
plt.plot(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE:index_22_ASE+length_list_ASE], ASE_mean_signal, color='r', label="P$_2$", alpha=1, linewidth=3)
# plt.fill_between(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE-110:index_22_ASE+length_list_ASE], ASE_mms_raw, ASE_mps_raw, color='r', alpha=0.2)
# 
plt.plot(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI:index_12_MDI+length_list_MDI], MDI_mean_signal, color='g', label="P$_3$", alpha=1, linewidth=3)
plt.plot(MMA_PREVAIL_LBM_028["j1_2"]["temps (s)"][index_12_MMA:index_12_MMA+length_list_MMA], MMA_mean_signal, linestyle=':', color='orange', label="P$_4$", alpha=1, linewidth=3)
plt.plot(MMA_PREVAIL_LBM_028["j1_2"]["temps (s)"][index_12_CBO:index_12_CBO+length_list_CBO], CBO_mean_signal, color='turquoise', label="P$_5$", alpha=1, linewidth=3)
plt.plot(PLA_PREVAIL_LBM_030["j1_2"]["temps (s)"][index_12_PLA:index_12_PLA+length_list_PLA], PLA_mean_signal, color='indigo', label="P$_6$", alpha=1, linewidth=3)
plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE:index_12_JPE+length_list_JPE], JPE_mean_signal, linestyle=':', color='lime', label="P$_7$", alpha=1, linewidth=3)
# plt.fill_between(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI-110:index_12_MDI+length_list_MDI], MDI_mms_raw, MDI_mps_raw, color='g', alpha=0.2)
plt.legend()
plt.xlim([0, 780])
plt.ylim([0, 650])
plt.xlabel("Time [s]")
plt.ylabel("LDF/LDF$_0$ [%]")
plt.grid()
plt.savefig('superp_mean_std_pc.jpg', bbox_inches='tight')
plt.close()

plt.rcParams.update({'font.size': 25})
plt.figure(figsize=(20, 12))
plt.plot(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22-110:index_22+length_list], JOL_Temperaturemean_signal_raw, color='b', label="P$_1$", alpha=1, linewidth=3)
# plt.fill_between(JOL_PREVAIL_LBM_008["j2_2"]["temps (s)"][index_22-110:index_22+length_list], JOL_Temperaturemms_raw, JOL_Temperaturemps_raw, color='b', alpha=0.2)
plt.plot(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE-110:index_22_ASE+length_list_ASE], ASE_Temperaturemean_signal_raw, color='r', label="P$_2$", alpha=1, linewidth=3)
# plt.fill_between(ASE_PREVAIL_LBM_009["j2_2"]["temps (s)"][index_22_ASE-110:index_22_ASE+length_list_ASE], ASE_Temperaturemms_raw, ASE_Temperaturemps_raw, color='r', alpha=0.2)
# 
plt.plot(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI-110:index_12_MDI+length_list_MDI], MDI_Temperaturemean_signal_raw, color='g', label="P$_3$", alpha=1, linewidth=3)
plt.plot(MMA_PREVAIL_LBM_028["j1_2"]["temps (s)"][index_12_MMA-110:index_12_MMA+length_list_MMA], MMA_Temperaturemean_signal_raw, linestyle=':', color='orange', label="P$_4$", alpha=1, linewidth=3)
plt.plot(MMA_PREVAIL_LBM_028["j1_2"]["temps (s)"][index_12_CBO-110:index_12_CBO+length_list_CBO], CBO_Temperaturemean_signal_raw, color='turquoise', label="P$_5$", alpha=1, linewidth=3)
plt.plot(PLA_PREVAIL_LBM_030["j1_2"]["temps (s)"][index_12_PLA-110:index_12_PLA+length_list_PLA], PLA_Temperaturemean_signal_raw, color='indigo', label="P$_6$", alpha=1, linewidth=3)
plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE-110:index_12_JPE+length_list_JPE], JPE_Temperaturemean_signal_raw, linestyle=':', color='lime', label="P$_7$", alpha=1, linewidth=3)
# plt.fill_between(MDI_PREVAIL_LBM_026["j1_2"]["temps (s)"][index_12_MDI-110:index_12_MDI+length_list_MDI], MDI_Temperaturemms_raw, MDI_Temperaturemps_raw, color='g', alpha=0.2)
...
# plt.plot(PLA_PREVAIL_LBM_030["j1_2"]["temps (s)"][index_12_PLA-110:index_12_PLA+length_list_PLA], PLA_Temperaturemean_signal_raw, color='fuchsia', label="P$_9$", alpha=1, linewidth=3)
# plt.legend()
plt.xlim([-60, 780])
plt.ylim([24, 33])
plt.xlabel("Time [s]")
...
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE-110:index_12_JPE+length_list_JPE], JPE_Temperaturemean_signal_raw, linestyle='-', color='red', label="P$_8$", alpha=1, linewidth=3)
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE-110:index_12_JPE+length_list_JPE], JPE_Temperaturemean_signal_raw, linestyle='-', color='darkgreen', label="P$_10$", alpha=1, linewidth=3)
# plt.plot(JPE_PREVAIL_LBM_031["j1_2"]["temps (s)"][index_12_JPE-110:index_12_JPE+length_list_JPE], JPE_Temperaturemean_signal_raw, linestyle='-', color='gold', label="P$_11$", alpha=1, linewidth=3)
# plt.legend()
plt.xlim([-60, 780])
plt.ylim([24, 33])
plt.xlabel("Time [s]")
