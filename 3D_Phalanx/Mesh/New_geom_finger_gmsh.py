...
gmsh.option.setNumber("Mesh.MeshSizeMin", min(lc1,lc2))
...
gmsh.model.mesh.field.setNumbers(distance, "FacesList", refine_1)
# 
threshold = gmsh.model.mesh.field.add("Threshold")
gmsh.model.mesh.field.setNumber(threshold, "IField", distance)
gmsh.model.mesh.field.setNumber(threshold, "LcMin", lc1)
gmsh.model.mesh.field.setNumber(threshold, "LcMax", lc)
gmsh.model.mesh.field.setNumber(threshold, "DistMin", d_min1)
gmsh.model.mesh.field.setNumber(threshold, "DistMax", d_max1)
# 
distance2 = gmsh.model.mesh.field.add("Distance")
gmsh.model.mesh.field.setNumbers(distance2, "FacesList", refine_2)
threshold2 = gmsh.model.mesh.field.add("Threshold")
gmsh.model.mesh.field.setNumber(threshold2, "IField", distance2)
gmsh.model.mesh.field.setNumber(threshold2, "LcMin", lc2)
gmsh.model.mesh.field.setNumber(threshold2, "LcMax", lc)
gmsh.model.mesh.field.setNumber(threshold2, "DistMin", d_min2)
gmsh.model.mesh.field.setNumber(threshold2, "DistMax", d_max2)

# If several local refinement, replicate the above procedure and complete the list
minimum = gmsh.model.mesh.field.add("Min")
gmsh.model.mesh.field.setNumbers(
    minimum, "FieldsList", [threshold,threshold2])
